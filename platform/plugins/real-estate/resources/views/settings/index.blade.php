            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20">
                    <div class="form-group">
                        ...
                        <div class="ui-select-wrapper">
                            <select name="real_estate_enabled_register" class="ui-select" id="real_estate_enabled_register">
                                <option value="1" @if (setting('real_estate_enabled_register', '1') == 1) selected @endif>{{ trans('core/base::base.yes') }}</option>
                                <option value="0" @if (setting('real_estate_enabled_register', '1') == 0) selected @endif>{{ trans('core/base::base.no') }}</option>
                            </select>
                            <svg class="svg-next-icon svg-next-icon-size-16">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                            </svg>
