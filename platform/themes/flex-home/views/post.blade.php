                                    ...
                                    <div class="grid-shadow grid-shadow-gray">
                                        ...
                                        <div class="grid-h">
                                            <div class="blog-title">
                                                ...
                                                <div class="post-meta"><p class="d-inline-block">{{ $relatedItem->created_at->format('d M, Y') }}</p> - <p class="d-inline-block"><i class="fa fa-eye"></i> {{ number_format($relatedItem->views) }}</p></div>
                                            </div>
