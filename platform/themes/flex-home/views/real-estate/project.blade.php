    ...
    <div class="container-fluid bgmenupro">
        <div class="container-fluid w90 padtop30" style="padding: 15px 0;">
            <div class="col-12">
                ...
                <p class="addresshouse"><i class="fas fa-map-marker-alt"></i> {{ $project->city->name }}, {{ $project->city->state->name }}</p>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-sm-6 lineheight220">
                            ...
                            @if ($project->category->name) <div><span>{{ __('Category') }}:</span> <b>{{ $project->category->name }}</b></div> @endif
                            ...
                            <div>
                                ...
                                <b>@if ($project->price_from)
                                    ...
                                    {{ format_price($project->price_from, $project->currency, false)  }} @endif
