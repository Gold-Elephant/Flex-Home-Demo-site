(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#ajax-filters-form button[type=reset]', function () {
            $('#ajax-filters-form').find(':input[name]').val('').trigger('change');
            $('#ajax-filters-form').trigger('submit');
        });
        ...
        function showTextForDropdownSelect($el) {
            let text = [];
            $el.find('select[name]').map(function (e) {
                const $this = $(this);
        ...
        $(document).on('change keyup', 'input.min-input, input.max-input', function (e) {
        ...
        //Property detail
        const $trafficMapModal = $('#trafficMapModal');
        let trafficMap;
        ...
        function setTrafficMap($related) {
            ...
            $trafficMapModal.find('.modal-title').text($('h1').text());
        ...
        if (jQuery().magnificPopup) {
            ...
            $('.show-gallery-image').on('click', function () {
                $('#listcarouselthumb .showfullimg:first').trigger('click');
            });
